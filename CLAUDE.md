...
Ventoy configuration / USB boot configuration project and supporting documentation site/tooling.
...
Claude Code / Emdash should auto-select this overlay when repository evidence points to **jumpusb.com**:
...
- Ventoy config workflows, boot entries, and USB setup guidance
- Validation of configuration generation and compatibility assumptions
- Safety warnings, backup guidance, and troubleshooting paths
- Docs with OS/device matrices, examples, and recovery instructions
